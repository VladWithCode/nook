...
export function NookLogo(
    { className, ...props }:
        {
            className?: string;
        } & React.SVGAttributes<SVGSVGElement> & React.HTMLProps<SVGSVGElement>,
) {
    return (
        <svg
        ...
        >
            <g id="whole_g">
                <path id="k" d="M451.6,128.7l16.9-4.9,33.4-80.1h37.3l-37,80.8c3.5,1.8,7.4,2.8,10.8,4.7,15,8.8,19.7,27.9,22.2,44,4,26.6,3.4,53.8,4.7,80.7h-35v-33.4c-2-14.6.4-49.1-12.4-59-9.1-7.1-30.3-2.9-40.8.3v92.1h-34.4V43.7h33.4l1,1v84h0Z" data-animatable-vector />
                <g id="o2_g">
                    <rect id="line2" x="290" y="193.6" width="104.5" height="29.9" />
                    <path id="o2" d="M335.3,46.5c-74.8,7.2-68.8,132.7,10.2,128.3,79.6-4.4,74-136.4-10.2-128.3ZM342.2,146.3c-33.8.2-35.4-66.9-3.7-71.2,39-5.3,40.1,71,3.7,71.2Z" data-animatable-vector />
                </g>
                <g id="o1_g">
                    <rect id="line1" x="142.8" y="227.4" width="118.1" height="34.4" />
                    <path id="o1" d="M196.5,60.2c-84.1,6.3-82.2,139.6-1.5,145.8,99.9,7.7,98.3-153,1.5-145.8ZM205.4,173.5c-43,4.3-44.2-76.6-6.9-80.9,42.4-4.9,44,77.2,6.9,80.9Z" data-animatable-vector />
                    <g id="circle_g">
                        <ellipse id="left_circle" cx="171.6" cy="22.1" rx="22.1" ry="21.9" />
                        <ellipse id="right_circle" cx="231" cy="21.9" rx="22.1" ry="21.9" />
                    </g>
                </g>
                <polygon id="n" points="33.1 44.4 89.5 171.6 89.5 44.4 118.1 44.4 118.1 254.6 92.5 254.6 29.2 117.1 29.2 253.6 28.2 254.6 1 254.6 0 253.6 0 44.4 33.1 44.4" data-animatable-vector />
            </g>
        </svg>
    );
}
